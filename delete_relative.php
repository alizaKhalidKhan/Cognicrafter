...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $deleteRelative = "DELETE FROM relative WHERE Relative_id = '$relativeId'";

    if (mysqli_query($connect, $deleteRelative)) {
        header("Location: c_relative.php");
        exit();
    } else {
        echo "Error deleting relative: " . mysqli_error($connect);
    }
}
?>
...
<body>
    ...
    <div class="container">
        ...
        <p>Are you sure you want to delete the relative <strong><?= $rowRelative['Relative_name'] ?></strong>?</p>
