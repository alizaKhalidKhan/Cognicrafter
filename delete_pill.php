...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $deletePill = "DELETE FROM pillreminder WHERE Pill_id = '$pillId'";

    if (mysqli_query($connect, $deletePill)) {
        header("Location: c_pill.php");
        exit();
    } else {
        echo "Error deleting Pill: " . mysqli_error($connect);
    }
}
?>
...
<body>
    ...
    <div class="container">
        ...
        <p>Are you sure you want to delete the pill <strong><?= $rowPill['Pill_name'] ?></strong>?</p>
        <form action="" method="post">
            <button type="submit" class="btn btn-danger" name="delete">Delete</button>
            <a href="c_pill.php" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
